import { useSSRContext, defineComponent, resolveComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, ref, createTextVNode } from 'vue';
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    function downloadResume() {
      saveAs(resume.value, "curriculo-Jos\xE9_Victor_Pessoa.pdf");
    }
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_row, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="ma-0 pa-0 text-textSecondary" style="${ssrRenderStyle({ "font-size": "1rem", "font-weight": "600" })}" data-v-63e7c8c8${_scopeId3}> Escreval (&quot;<span class="ma-0 pa-0 text-primary" style="${ssrRenderStyle({ "font-size": "1.5rem" })}" data-v-63e7c8c8${_scopeId3}>Ol\xE1, Mundo!!!</span>&quot;) </span>`);
                      } else {
                        return [
                          createVNode("span", {
...
const timeline = [
  {
    mes: "Nov",
    ano: "2022",
    description: "Tive meu primeiro contato com a \xE1rea de programa\xE7\xE3o, onde essas experi\xEAncias despertaram meu interesse pela tecnologia."
  },
  {
    mes: "Dez",
    ano: "2023",
  ...
  },
  {
    mes: "Jul",
    ano: "2024-2028",
    description: "Atualmente, estou me aprimorando com os melhores profissionais na Jala University, com o objetivo de concluir minha forma\xE7\xE3o e me tornar um profissional de excel\xEAncia."
  }
];
const _sfc_main$3 = {
  __name: "about-me",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_v_col, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div data-v-de06be3e${_scopeId4}><p class="ma-0 pa-0 text-justify" data-v-de06be3e${_scopeId4}> Sou um desenvolvedor front-end cursando Engenharia de Software na <span class="font-weight-bold" data-v-de06be3e${_scopeId4}><a data-v-de06be3e${_scopeId4}><a href="https://jala.university/" target="_blank" class="text-secondary text-decoration-none" data-v-de06be3e${_scopeId4}>Jala University</a></a></span>. Atualmente, me dedico no desenvolvimento de projetos que unem estudos e prop\xF3sito, como meu portf\xF3lio profissional e um site de livros cat\xF3licos online. Estou em busca de novas oportunidades para expandir minhas habilidades e contribuir para projetos significativos. </p></div>`);
                            } else {
                              return [
                                createVNode("div", null, [
                                  createVNode("p", { class: "ma-0 pa-0 text-justify" }, [
                                    ...
                                    createTextVNode(". Atualmente, me dedico no desenvolvimento de projetos que unem estudos e prop\xF3sito, como meu portf\xF3lio profissional e um site de livros cat\xF3licos online. Estou em busca de novas oportunidades para expandir minhas habilidades e contribuir para projetos significativos. ")
                                  ])
                                ])
                              ];
                            }
...
//# sourceMappingURL=index-C4_cHE0W.mjs.map
